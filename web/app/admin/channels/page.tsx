    ...
    <AdminShell>
      ...
      {kind === "channel" ? (
        <AdminListPanel<Channel>
          ...
          actions={<OpenCreateButton label="新建渠道" onClick={() => setCreateChannel(true)} />}
          columns={[
      ...
      {kind === "agent" ? (
        <AdminListPanel<Role>
          ...
          actions={<OpenCreateButton label="新建代理商" onClick={() => setCreateAgent(true)} />}
          columns={[
            { accessorKey: "id", header: "ID" },
      ...
      {kind === "kol" ? (
        <AdminListPanel<Role>
          ...
          actions={<OpenCreateButton label="新建 KOL" onClick={() => setCreateKOL(true)} />}
          columns={[
            { accessorKey: "id", header: "ID" },
            {
              accessorKey: "type",
